...
export class ContentsComponent implements OnInit {
  ...
  chart = new Chart({
    ...
    title: { text: 'Month wise Contacts Management ' },
    xAxis: {
      categories: [
        'Jan',
        'Feb',
    ...
    series: [
      {
        ...
        type: 'line',
        color: '#044342',
        data: [70, 69, 95, 145, 182, 215, 252, 265, 233, 190, 199, 196],
      },
      {
        name: 'Pune',
        type: 'line',
        color: '#7e0505',
        data: [37, 42, 54, 100, 118, 169, 132, 153, 171, 150, 139, 120],
      },
      {
        name: 'Akola',
        type: 'line',
        color: '#ed9e20',
        data: [17, 22, 14, 25, 80, 70, 100, 105, 80, 32, 29, 59],
      },
    ],
    credits: {
      enabled: false,
  ...
  chartCategory = new Chart({
    ...
    title: {
      text: 'City wise Contact collection',
    },
    xAxis: {
      categories: [
        'CSE',
...
chartProduct = new Chart({
  ...
  title: {
    text: 'Highest Call Center Cities'
  },
  xAxis: {
    categories: [
      ' Delhi',
